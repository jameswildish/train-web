...
const STATIC_PROJECTS: StaticProject[] = [
  { href: '/projects/ddm', cat: 'data', thumbClass: 'thumb anemone', thumbStyle: {}, cardClass: 'project', tag: 'Data infrastructure · 2026', title: 'Data Donation Platform (DDM)', desc: 'Building inclusive, real-world health data from diverse populations — to make prevention and research more representative.' },
