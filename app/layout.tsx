  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        {/* Must be inline in head so it's defined before translate.js callback fires */}
      ...
      <body>
        {/* Not visibility:hidden — widget won't render select element if container is invisible */}
