      ...
      <section className="app-features">
        <div className="wrap">
          <div className="head">
            ...
            <p>Grounded in circadian science, autonomic regulation, and sleep-stage research — and built to adapt to your patterns.</p>
          </div>
          <SleepAppFeatures />
        </div>
      </section>
          ...
          <div className="qa" style={{ borderTop: 'none' }}>
            <div>
              ...
              <ul className="steps">
                ...
                <li><strong>Be physically active</strong>Regular activity influences circadian timing, body temperature regulation, and adenosine accumulation — and supports deeper slow-wave sleep.</li>
              </ul>
            </div>
          </div>
        </div>
